    ...
    try {
      ...
      if (saved) {
        ...
        return {
          ...
          fdGoals: parsed.fdGoals || [],
          fdTasks: parsed.fdTasks || [],
          fdHabits: parsed.fdHabits || [],
          fdHabitLogs: parsed.fdHabitLogs || [],
          summaryDocs: parsed.summaryDocs || [],
          summaryIdeas: parsed.summaryIdeas || [],
          summaryLogs: parsed.summaryLogs || [],
        };
      }
    } catch (e) {
  ...
  const saveLocalData = useCallback((data: SyncData) => {
    try {
      ...
      const saveData = {
        ...
        // ✅ 保留 FocusDesk / Summary Desk 数据，避免被覆盖丢失
        fdGoals: data.fdGoals || appStateData.fdGoals || [],
        fdTasks: data.fdTasks || appStateData.fdTasks || [],
        fdHabits: data.fdHabits || appStateData.fdHabits || [],
        fdHabitLogs: data.fdHabitLogs || appStateData.fdHabitLogs || [],
        summaryDocs: data.summaryDocs || appStateData.summaryDocs || [],
        summaryIdeas: data.summaryIdeas || appStateData.summaryIdeas || [],
        summaryLogs: data.summaryLogs || appStateData.summaryLogs || [],
        userSettings: appStateData.userSettings || {},
      };
  ...
  const performSync = useCallback(async (userId: string) => {
    ...
    try {
      ...
      const CATEGORY_TO_TABLE: Record<DeletedIdsCategory, string> = {
        ...
        fdTasks: 'fd_tasks',
        fdHabits: 'fd_habits',
        fdHabitLogs: 'fd_habit_logs',
        summaryDocs: 'summary_docs',
        summaryIdeas: 'summary_ideas',
        summaryLogs: 'summary_logs',
      };
      ...
      if (totalDirty === 0 && totalDeletedFromCloud === 0) {
        ...
        const mergedData: SyncData = {
          ...
          fdGoals: mergeData(localData.fdGoals || [], remoteData.fdGoals || [], syncedAtStr, false, true),
          fdTasks: mergeData(localData.fdTasks || [], remoteData.fdTasks || [], syncedAtStr, false, true),
          fdHabits: mergeData(localData.fdHabits || [], remoteData.fdHabits || [], syncedAtStr, false, true),
          fdHabitLogs: mergeData(localData.fdHabitLogs || [], remoteData.fdHabitLogs || [], syncedAtStr, false),
          summaryDocs: mergeData(localData.summaryDocs || [], remoteData.summaryDocs || [], syncedAtStr, false, true),
          summaryIdeas: mergeData(localData.summaryIdeas || [], remoteData.summaryIdeas || [], syncedAtStr, false, true),
          summaryLogs: mergeData(localData.summaryLogs || [], remoteData.summaryLogs || [], syncedAtStr, false, true),
        };
      ...
      if (success) {
        ...
        const mergedData: SyncData = {
          ...
          fdGoals: mergeData(syncedData.fdGoals || [], remoteData.fdGoals || [], syncedAtStr, true, true),
          fdTasks: mergeData(syncedData.fdTasks || [], remoteData.fdTasks || [], syncedAtStr, true, true),
          fdHabits: mergeData(syncedData.fdHabits || [], remoteData.fdHabits || [], syncedAtStr, true, true),
          fdHabitLogs: mergeData(syncedData.fdHabitLogs || [], remoteData.fdHabitLogs || [], syncedAtStr, true),
          summaryDocs: mergeData(syncedData.summaryDocs || [], remoteData.summaryDocs || [], syncedAtStr, true, true),
          summaryIdeas: mergeData(syncedData.summaryIdeas || [], remoteData.summaryIdeas || [], syncedAtStr, true, true),
          summaryLogs: mergeData(syncedData.summaryLogs || [], remoteData.summaryLogs || [], syncedAtStr, true, true),
        };
    ...
    try {
      ...
      if (success && data) {
        ...
        const mergedData: SyncData = {
          ...
          fdGoals: mergeData(localData.fdGoals || [], data.fdGoals || [], syncedAt, false, true),
          fdTasks: mergeData(localData.fdTasks || [], data.fdTasks || [], syncedAt, false, true),
          fdHabits: mergeData(localData.fdHabits || [], data.fdHabits || [], syncedAt, false, true),
          fdHabitLogs: mergeData(localData.fdHabitLogs || [], data.fdHabitLogs || [], syncedAt, false),
          summaryDocs: mergeData(localData.summaryDocs || [], data.summaryDocs || [], syncedAt, false, true),
          summaryIdeas: mergeData(localData.summaryIdeas || [], data.summaryIdeas || [], syncedAt, false, true),
          summaryLogs: mergeData(localData.summaryLogs || [], data.summaryLogs || [], syncedAt, false, true),
        };
